<%@ Page Title="" Language="C#" MasterPageFile="~/mainmaster.master" AutoEventWireup="true" CodeFile="OurStory.aspx.cs" Inherits="OurStory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="col-lg-12 col-xs-12 text-center" style="margin-top: 20px; pad
    ding-bottom: 20px; background-image: url('img/bg2.jpg')">
